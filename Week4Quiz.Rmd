...
```{r Plotting all IMDB Ratings and Lengths}
...
From these graphs it seems that the best predictor of the number of votes is the budget of the movie. Although there is an interesting shape to the relationship between the number of votes and the rating. I would say that movies that are well recieved or movies that have large budgets are voted on more often. There is also an interesting shape to the votes vs. year which would make sense because people are more likely to vote on newly released movies as opposed to going back and voting on older movies.